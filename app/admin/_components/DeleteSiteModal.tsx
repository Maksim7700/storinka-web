...
type Props = {
  ...
  onClose: () => void;
  /**
   * Called after a successful DELETE. If omitted, falls back to
   * router.push('/admin'). Useful when the caller already lives on the
   * dashboard and just wants to drop the card from local state.
   */
  onDeleted?: () => void;
};
      ...
      >
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <button
            ...
            className="flex h-12 w-full cursor-pointer items-center justify-center rounded-[10px] bg-red-600 px-4 text-base font-semibold leading-[1.4] tracking-[0.02em] text-white transition hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
